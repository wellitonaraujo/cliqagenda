    ...
    {collaborators && collaborators.length === 0 ? (
      ...
      <div className="flex flex-col gap-4 p-6 flex-1 overflow-y-auto">
        {collaborators.map((colab, index) => (
          <div key={index} className="flex items-center gap-4 border p-4 rounded-lg shadow-sm border-gray-300">
            ...
            <div>
              <p className="font-semibold text-md">{colab.name} ({colab.nickname})</p>
